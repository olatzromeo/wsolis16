...
function eskaeraPasahitza($pasahitza){
	$bezeroa = new nusoap_client('http://probakws.hol.es/wsolis16-2/egiaztatuPasahitza.php?wsdl', true);
	$emaitza= $bezeroa->call('konprobatuPasahitza',array('pasahitz'=>$pasahitza));
	return $emaitza;
}

function eskaeraTicketa($ticket){
	$bezeroa = new nusoap_client('http://probakws.hol.es/wsolis16-2/egiaztatuTicketa.php?wsdl', true);
